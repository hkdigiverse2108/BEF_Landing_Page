  ...
  return (
    <section id="about" className=" relative overflow-hidden pt-10 pb-1 ">
      <div className="container container-p flex flex-col lg:flex-row items-center gap-12">
        {/* Left Div */}
        <div className=" relative flex justify-center items-center w-full md:w-1/2 lg:w-full " data-aos="fade-right">
          <div
          ...
          <img src={`${ImagePath}about/about-frame.png`} alt="App Main Screen" className="w-64 sm:w-80 smooth-float " data-aos="zoom-in" />
          <img
