      ...
      <div className="container mx-auto py-12 md:py-24 px-5 lg:px-10  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className=" space-y-6 md:space-y-12">
          ...
          <div className="space-y-5 text-sm sm:text-base">
            ...
            <Link to="" className="flex items-center gap-2">
              S-251 Angle Business Center-2, Mota Varachha, Surat, Gujrat,
              India-394101
            </Link>
          </div>
          ...
          <div className="flex gap-3 mt-4">
            {[FaInstagram, FaTwitter, FaTelegramPlane, ImYoutube].map(
              (Icon, idx) => (
                <Link
                  key={idx}
                  to={""}
        ...
        <div className=" space-y-6 md:space-y-12">
          ...
          <div className="flex flex-col gap-4">
            <img
              ...
              alt="App Store"
              className="px-4 py-2 bg-white rounded-lg w-36 sm:w-40 cursor-pointer"
            />
            <img
